...
while Loss > Loss_Threshold and a15:
    ...
    for i in range(0, Batch_size):
        ...
        for m in range(0, Mini_Batch_repetitions):

            real_outputs = []
            loss_gradient = []

            Y = F.Baralha_Listas(X, expected_outputs, Batch_size_training)
            ...
            for a21, i in enumerate(Y):
                ...
                loss_gradient.append(F.gradient_of_loss_multiple_output_neurons(expected_outputs[a21], current_input, scale_gradient_of_loss))
