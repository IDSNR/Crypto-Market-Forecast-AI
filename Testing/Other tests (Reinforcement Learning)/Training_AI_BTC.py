...
media_expected_outputs = sum(expected_outputs)/len(expected_outputs)
...
neural_network_layers_and_its_neurons = [input_layer_n_neurons, 10, 5, 4, 5, 1] #se tivesse mais de um output poria mais um layer
