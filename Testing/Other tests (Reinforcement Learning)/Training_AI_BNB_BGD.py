...
'''
with open("Database_weights_and_biases_"+str(crypto_name)+"_BGD_.json", "r") as file:
   load = json.load(file)
...
while Loss > 1e-4:
    ...
    for i in range(0, Batch_size):
        ...
        if a5 == Batch_size - 1:
            ...
            best_set_of_biases_yet = lists_for_optimization_bias[a[0]]
            best_set_of_weights_yet = lists_for_optimization_weigths[a[0]]
            loss_b = loss[a[0]]
            accuracy_b = accuracy[a[0]]
            a3 = 1
            a8 = True
            color.cprint("\nNova Batch!!!\n", "light_green")
            raise NameError
        ...
        if a8:
            ...
            try:
                with open("Database_weights_and_biases_"+str(crypto_name)+"_BGD_.json", "w") as file:
