...
scale = 0.1
begginer_number = 1
neural_network_layers_and_its_neurons = [input_layer_n_neurons, 50, 25, 5, 3, 1] #se tivesse mais de um output poria mais um layer
...
while Loss > 1e-4:
    ...
    for i in range(0, 10000):
        ...
        for i in X:
            ...
            Output_layer.forward(output_layer_1)
        ...
        if a8:
            ...
            try:
                with open("Database_weights_and_biases_Test_1_"+str(crypto_name)+".json", "w") as file:
