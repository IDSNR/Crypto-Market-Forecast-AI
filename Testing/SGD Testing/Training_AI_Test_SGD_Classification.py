...
while Loss > Loss_Threshold and a15:
    ...
    for i in range(0, Batch_size):
        ...
        for k in range(0, SGD_Batch_Size):
            ...
            expected_outputs2.append(expected_output)
            ...
            loss_gradient = F.gradient_of_loss_multiple_output_neurons(expected_output, current_input, scale_gradient_of_loss)
